...
excerpt: Ubuntu에 Tailscale 설치하여 안전하게 원격 접속하기
...
먼저 [Tailscale 홈페이지](https://tailscale.com/)에 접속하여 회원가입을 한다.  
 ...
 ![screenshot-8218856](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8218856.png)

  

그 다음 자신의 기기(인스턴스 말고)의 운영체제에 맞는 걸로 다운로드한다.  

![screenshot-8218913](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8218913.png)
...
![screenshot-8219707](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8219707.png)

우선 Linux를 선택하고 밑으로 스크롤 하면 Ubuntu 22.04 LTS 에 대한 설치 메뉴얼이 있다.  

  

![screenshot-8219782](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8219782.png)

나와 있는 순서대로 명령어를 입력하면 된다. 여기서  **3번 과정** `sudo tailscale up` 을 하면 tailscale을 실행하고 아래와 같이 링크가 뜬다. 저 링크를 자신의 데스크탑(필자의 경우 맥북)에서 접속하자. 



![screenshot-8219950](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8219950.png)

  

접속하면 Tailscale 로그인 창이 뜰 것이다. 로그인을 하면 연결 버튼이 아래와 같이 뜬다.  

![screenshot-8220173](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8220173.png)
...
![screenshot 3](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot 3.png)

필자의 맥북 `~/.ssh/config` 파일이다. `Host kr-1` 설정은 실제 인스턴스의 IP로 접속하는 설정이고, 그 밑에 `Host kr-1-ts` 설정은 tailscale IP로 접속하는 설정이다. HostName 필드 부분이 원격 접속할 대상의 IP이므로, `Host kr-1-ts`의 HostName 필드에 tailscale IP를 입력하면 된다.(tailscale IP는 [Admin 콘솔](https://login.tailscale.com/admin/machines)에서 확인 가능)  
...
![screenshot-8221132](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8221132.png)
...
![screenshot 4](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot 4.png)
...
![screenshot-8221957](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8221957.png)
...
![screenshot-8223346](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8223346.png)
...
![screenshot-8222975](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8222975.png)

![screenshot-8223949](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8223949.png)
...
![screenshot-8222233](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8222233.png)

![screenshot-8222242](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8222242.png)
...
![screenshot-8223064](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot-8223064.png)
...
![screenshot](/assets/images/posts_img/2024-06-12-ubuntu-tailscale-install/screenshot.png)
